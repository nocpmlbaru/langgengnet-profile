...
export default function PublicAiCs() {
  ...
  return <div className={`public-ai ${open ? "is-open" : ""}`}>
    {open && <section className="public-ai-panel" aria-label="AI Customer Service Langgeng Net">
      <div className="public-ai-head"><div><strong>AI CS Langgeng Net</strong><small>Customer service</small></div><button type="button" onClick={() => setOpen(false)} aria-label="Tutup AI CS">×</button></div>
